...
class RestrictedBField_Samu_red final : public MagneticFieldProvider {
 public:
  struct Cache {
  ...
  RestrictedBField_Samu_red( const Vector3& field)
      :  m_BField(field) {}
      
      std::shared_ptr<TrackingVolume> m_magVolume = TrackingVolume::create(Transform3(Translation3{13500., 0., 0.}),std::make_shared<const CuboidVolumeBounds>(2000., 1300., 500.));
