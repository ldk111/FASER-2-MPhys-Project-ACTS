...
class RestrictedBFieldIndu3_2m final : public MagneticFieldProvider {
 public:
  struct Cache {
  ...
  RestrictedBFieldIndu3_2m( const Vector3& field)
      :  m_BField(field) {}
...
//Acts::RotationMatrix3 rotation << 0, 0, -1, 0, 1, 0,1, 0, 0;
  ...
  std::shared_ptr<TrackingVolume> m_magVolume = TrackingVolume::create(Transform3(translation_*AngleAxis3(3.14*0.5, Vector3(0., 1., 0.))),std::make_shared<const CylinderVolumeBounds>(0.0, 1200., 2100.));
