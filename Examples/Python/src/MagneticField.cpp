...
void addMagneticField(Context& ctx) {
  ...
  // py::class_<RestrictedBFieldCylindrical2, Acts::MagneticFieldProvider, std::shared_ptr<RestrictedBFieldCylindrical2>>(m, "RestrictedBFieldCylindrical2")
  //     // .def(py::init<Acts::Vector3&, std::array<double,3>&, std::array<double,3>&>());
  //     .def(py::init<Acts::Vector3, std::array<double,3>, std::array<double,3>>());

  // py::class_<RestrictedBFieldCylindrical3, Acts::MagneticFieldProvider, std::shared_ptr<RestrictedBFieldCylindrical3>>(m, "RestrictedBFieldCylindrical3")
  //     .def(py::init<Acts::Vector3, Acts::Vector3, std::array<double, 3>>(),
  //          "field"_a, 
  //          "translation_param"_a = Acts::Vector3(13500., 0., 0.), 
  // 	     "volumeBounds_param"_a = std::array<double, 3>{0.0, 1500., 500.});
